...
//	   for (int i = 0; i < index_machin.length; i++) {System.out.println(index_machin[i]);}
   ...
   public  static void jobshop_exhaust() { 
	   Scanner sc = new Scanner(System.in);
   ...
   public  static void jobshop_ver() { 
	  System.out.println("On utlise donne1 comme exemple");
	  ...
	  String certificat = sc.next();
	  if(certificat.length()!=8) {System.out.println("you dont have so many taches");jobshop_ver();}
	  ...
	  for (int i = 0; i < certificat.length(); i++) {
		  ...
		  if( index_machines[i]>1) {System.out.println("you dont have so many machines");jobshop_ver();break;}
		  }
  ...
  String resultat= test(  d,certificat,2) ;

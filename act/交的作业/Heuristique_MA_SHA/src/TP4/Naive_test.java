...
public class Naive_test {
	static List<Tache> taches = new ArrayList<Tache>();
	static int[] table = new int[100000];

	public static void naive_test() {
		int delay = 0;
		taches.add(new Tache(0, 50, 1200, 0));
		taches.add(new Tache(0, 20, 3600, 1));
		taches.add(new Tache(0, 20, 3600, 2));
		taches.add(new Tache(0, 20, 3600, 3));
		taches.add(new Tache(2400, 75, 120, 4));
		taches.add(new Tache(3000, 15, 7200, 5));
		taches.add(new Tache(3400, 42, 1337, 6));

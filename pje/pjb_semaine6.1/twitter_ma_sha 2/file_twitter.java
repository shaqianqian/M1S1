...
public class file_twitter {
    ...
    public static boolean writeToFiche(ArrayList<String> linesOfFile,String file_name) throws IOException {
     ...
     public static boolean writeToFiche_suc(ArrayList<String> linesOfFile,String file_name) throws IOException {
        ...
        try ( BufferedWriter out = new BufferedWriter(new FileWriter(file_name,true));){
            for(String line : linesOfFile) {
                out.write(line);
            }
             out.close();

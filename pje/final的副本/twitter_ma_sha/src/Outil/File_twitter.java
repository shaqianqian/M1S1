...
public class File_twitter {
    ...
    public static boolean writeToFiche(List<String> linesOfFile, String file_name) throws IOException {
       File nf = new File(File_twitter.class.getResource("/Fiches/"+file_name).getPath());
        try (BufferedWriter out = new BufferedWriter(new FileWriter(nf));) {
    ...
    public static ArrayList<String> readFromFiche(String nomFichier) {
        ...
        try {
            ...
            String str = null;
            File nf = new File(File_twitter.class.getResource("/Fiches/"+nomFichier).getPath());
    ...
    public static ArrayList<String> readTxtFileIntoStringArrList(String filePath) {
        ...
        try {
            File nf = new File(File_twitter.class.getResource("/Fiches/"+filePath).getPath());
            File file = nf;
